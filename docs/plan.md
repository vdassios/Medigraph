...
| 2.8b | `pnpm corpus:templates` — fingerprint every page of the corpus and assert the separation claim: at least six distinct profiles across the four labs, and **zero** cross-template matches. Galinos haematology against Galinos biochemistry is the named case, since they share a masthead, a generator and a lab. **This task can falsify the feature**: if the fingerprint cannot separate them cleanly, 2.9 and 4.2b do not ship. | 2.8, 0.5a                 |
...
the separation claim Pass T rests on: at least six distinct profiles across the four
labs, and zero cross-template matches — Galinos haematology against Galinos
biochemistry being the named pair, identical in masthead, generator and lab. A
